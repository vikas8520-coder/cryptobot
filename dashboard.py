...
BOTS = [
    ("Spot", 8080, "pass8080", "Trend-follow · spot"),
    ("Futures", 8081, "pass8081", "Long / short · futures"),
    ("Braked Hold", 8082, "pass8082", "200-day brake · spot"),
    ("Scalp", 8083, "pass8083", "VWAP reversion · 5m LAB"),
    ("Day Trade", 8084, "pass8084", "Opening-range breakout · 1h LAB"),
]
    ...
    try:
        if a in CRYPTO_COINS:
            r = requests.get("http://127.0.0.1:8082/api/v1/pair_candles",
                             ...
                             auth=HTTPBasicAuth("freqtrader", "pass8082"), timeout=10).json()
