...
#
# THESIS: RSI(2) < 5 is extremely oversold — price is likely to snap back.
# Combined with a higher-timeframe uptrend filter, this catches dips in
# bull markets. Exit when RSI(2) > 50 (momentum restored).
#
# This is a mean-reversion strategy, but on 1h (not 5m) where moves are bigger.
# The key difference from the failed VWAP reversion: RSI-2 < 5 is a much
# more extreme filter than "price below VWAP band" — it only triggers on
# genuine panic selling.
